...
async function main(): Promise<void> {
  ...
  if (!query || !targetPath) {
    console.error('Usage: npx tsx src/index.ts "<query>" <path-to-repo>');
    console.error('Example: npx tsx src/index.ts "How does auth work?" ./demo/sample-repos/nextjs-starter');
    process.exit(1);
  }
